...
use lethe_api::api::envelope::ResponseEnvelope;
use lethe_api::api::health::HealthResponse;
use lethe_api::api::pagination::{PaginationParams, paginate};
use lethe_api::api::read_mode::ReadModeResolver;
use lethe_core::domain::*;
use lethe_engine::identity::projector::IdentityProjector;
use lethe_engine::lake::store::LakeStore;
use lethe_engine::projection::BuildStatus;
...
use lethe_engine::propagation::watermark::WatermarkStore;
use lethe_policy::governance::filter::FilteringGate;
use lethe_policy::governance::types::{AccessScope, MaskStrategy, RestrictedFieldSpec};
...
fn api_response_envelope_contract() {
    ...
    let metadata = lethe_api::api::envelope::ProjectionMetadata {
