...
use lethe_adapter_api::writeback::WriteRecord;
use lethe_adapter_gslides::gslides::mapper::WORKSPACE_SNAPSHOT_SCHEMA;
...
use lethe_profile_model::{SlideAnalysisResult, StudentProfile};
...
impl SlideAnalysisProjector {
    ...
    pub fn create_analysis_observation(
        result: &SlideAnalysisResult,
    ) -> lethe_adapter_api::traits::ObservationDraft {
