...
use lethe_core::domain::types::{AuthorityModel, WriteMode};
...
mod tests {
    use super::*;
    use lethe_core::domain::values::{ActorRef, EntityRef, ProjectionRef};
    ...
    fn allow_internal_read() {
        let req = make_request(
            Role::Researcher,
            Operation::Read {
                target: EntityRef::new("person:alice"),
            },
    ...
    fn require_review_for_publication() {
        let req = make_request(
            Role::SystemAdmin,
            Operation::Publish {
                projection: ProjectionRef::new("proj:person-page"),
            },
            AccessScope::Internal,
            ConsentStatus::Unrestricted,
            Environment::Production,
    ...
    fn agent_can_run_build() {
        let req = make_request(
            Role::Agent,
            Operation::RunBuild {
                projection: ProjectionRef::new("proj:test"),
            },
            AccessScope::Internal,
            ConsentStatus::Unrestricted,
            Environment::Sandbox,
