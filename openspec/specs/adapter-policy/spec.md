# Specification: adapter-policy

## Purpose

Adapter mapping contracts define source-specific canonical tuple, identity, and ingest boundary rules that preserve LETHE exact idempotency and keep source interpretation out of ingestion.
