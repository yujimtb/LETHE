# Spec Delta: corpus-projection

**Change:** workspace-search-support
**Module:** (new) corpus-projection
**Scope:** Bot 向け Access Controlled Corpus Projection
**Dependencies:** M01 Domain Kernel, M03 Observation Lake, M05 Projection Engine, M06 DAG Propagation, M08 Governance
**Agent:** Spec Designer (Projection spec + フィルタルール) → Implementer (Projector) → Reviewer (exposure 検証)
